...
insert into Course(credit_hours) VALUES(6)
insert into Semester(semester_code) VALUES(6)
...
insert into Student(assigned_hours) values(30)
insert Payment(payment_id,student_id) values(1,1)
